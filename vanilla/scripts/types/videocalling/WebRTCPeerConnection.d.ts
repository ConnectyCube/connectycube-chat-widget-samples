...
import { PeerConnectionState } from '../types/enums';
export default class WebRTCPeerConnection {
    ...
    onStatusClosedChecker: NodeJS.Timeout | number | null;
    dialingTimer: NodeJS.Timeout | number | null;
    statsReportTimer: NodeJS.Timeout | number | null;
    waitingReconnectTimeoutCallback: NodeJS.Timeout | number | null;
    released: boolean;
    ...
    setRTCRtpSenderMaxBandwidth(maxBandwidth: number): void;
