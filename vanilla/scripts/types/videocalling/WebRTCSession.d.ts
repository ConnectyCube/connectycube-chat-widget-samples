...
import { CallSessionConnectionState, CallSessionState, CallType, MediaType, PeerConnectionState } from '../types/enums';
...
export default class WebRTCSession {
    ...
    answerTimer: NodeJS.Timeout | number | null;
    waitingOfferOrAnswerTimer: NodeJS.Timeout | number | null;
